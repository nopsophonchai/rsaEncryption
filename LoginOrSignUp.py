...
Loginbutton = tk.Button(master=frame, width=6, height=1, text="Back", font=("Century Gothic", 20), bg="#0097B2")
...
Signupbutton = tk.Button(master=frame, width=6, height=1, text="Back", font=("Century Gothic", 20), bg="#FF5757")
